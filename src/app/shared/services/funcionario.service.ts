...
import { FuncionarioList } from '../models/funcionario.interface';
...
export class FuncionarioService {
  ...
  postFuncionario(): Observable<AppResponse<FuncionarioList>> {
    return this.http.post<AppResponse<FuncionarioList>>(`${this.apiUrl}`, {});
  }
}
